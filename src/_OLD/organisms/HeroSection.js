...
// import Chapeau from "../atoms/Chapeau";
...
export default function HeroSection() {
  return (
    <section className={styles.header}>
      <H1>Ik bedenk, ontwerp en ontwikkel websites voor iedereen!</H1>
      {/* <Chapeau><strong>Frontend developer en UX Designer. In Tilburg</strong></Chapeau> */}
      {/* <Chapeau>Momenteel in dienst bij Human Digital.</Chapeau> */}
    </section>
    // <section className=" w-screen min-h-screen flex justify-center items-center flex-col box-border">
    //   <div>
    //     <span>Welkom!</span>
    //     <h1>
    //       Hallo! Ik ben <strong>Marco Fijan</strong>
    //     </h1>
    //   </div>
