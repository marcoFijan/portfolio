            ...
            <Container>
              ...
              >
                      ...
                      >
                        ...
                        >
                          <circle
                            ...
                            r="12"
                            fill="#fff"
                            className="group-hover:fill-[#ffffff] fill-colorLogoBg transition-all duration-500"
                          ></circle>
                          <path
                            fill="#21759B"
                            ...
                            className="group-hover:fill-[#21759B] fill-colorLogoInner transition-all duration-500"
                          />
                        </svg>
                      </div>
                      <div
                      ...
                      >
                        ...
                        >
                          <path
                            ...
                            className="group-hover:fill-[#1ABCFE] fill-colorLogoInner transition-all duration-500"
                          />
                          <path
                            fill="#0ACF83"
                            d="M4 12.667c0-1.289 1.019-2.334 2.275-2.334H8.55v2.334C8.55 13.955 7.531 15 6.275 15S4 13.955 4 12.667z"
                            className="group-hover:fill-[#0ACF83] fill-colorLogoInner transition-all duration-500"
                          />
                          <path
                            fill="#FF7262"
                            d="M8.55 1v4.667h2.275c1.257 0 2.275-1.045 2.275-2.334C13.1 2.045 12.082 1 10.825 1H8.55z"
                            className="group-hover:fill-[#FF7262] fill-colorLogoInner transition-all duration-500"
                          />
                          <path
                            fill="#F24E1E"
                            d="M4 3.333c0 1.289 1.019 2.334 2.275 2.334H8.55V1H6.275C5.019 1 4 2.045 4 3.333z"
                            className="group-hover:fill-[#F24E1E] fill-colorLogoInner transition-all duration-500"
                          />
                          <path
                            fill="#A259FF"
                            d="M4 8c0 1.289 1.019 2.333 2.275 2.333H8.55V5.667H6.275C5.019 5.667 4 6.71 4 8z"
                            className="group-hover:fill-[#A259FF] fill-colorLogoInner transition-all duration-500"
                          />
                        </svg>
                      </div>
                      ...
                      >
                        ...
                        >
                          <path
                            ...
                            fill="#53C1DE"
                            className="group-hover:fill-[#53C1DE] fill-colorLogoInner transition-all duration-500"
                          />
                          <path
                            fill-rule="evenodd"
                            clip-rule="evenodd"
                      ...
                      >
                        ...
                        >
                          <path
                            ...
                            fill="#E44D26"
                            className="group-hover:fill-[#E44D26] fill-colorLogoBg transition-all duration-500"
                          />
                          <path
                            d="M26 5H16V29.5L24 27L26 5Z"
                            fill="#F16529"
                            className="group-hover:fill-[#F16529] fill-colorLogoBg transition-all duration-500"
                          />
                          <path
                            d="M9.5 17.5L8.5 8H24L23.5 11H11.5L12 14.5H23L22 24L16 26L10 24L9.5 19H12.5L13 21.5L16 22.5L19 21.5L19.5 17.5H9.5Z"
                            fill="white"
                            className="group-hover:fill-[#ffffff] fill-colorLogoInner transition-all duration-500"
                          />
                        </svg>
                      </div>
                      ...
                      >
                        ...
                        >
                          <rect
                            ...
                            height="28"
                            fill="#FFCA28"
                            className="group-hover:fill-[#FFCA28] fill-colorLogoBg transition-all duration-500"
                          />
                          <path
                            ...
                            fill="#3E3E3E"
                            className="group-hover:fill-[#3E3E3E] fill-colorLogoInner transition-all duration-500"
                          />
                          <path
                      ...
                      >
                        ...
                        >
                          <path
                            ...
                            className="group-hover:fill-[#264de4] fill-colorLogoBg transition-all duration-500"
                          />
                          <path
                            fill="#2965f1"
                            d="M256 37V472l149-41 35-394"
                            className="group-hover:fill-[#2965f1] fill-colorLogoBg transition-all duration-500"
                          />
                          <path
                            fill="#ebebeb"
                            d="m114 94h142v56H119m5 58h132v57H129m3 28h56l4 45 64 17v59L139 382"
                            className="group-hover:fill-[#ebebeb] fill-colorLogoInner transition-all duration-500"
                          />
                          <path
                            fill="#ffffff"
                        ...
                        >
                          <g id="KenticoLogo" data-name="KenticoLogo">
                            <circle
                              ...
                              r="75"
                              fill="#f05a22"
                              className="group-hover:fill-[#f05a22] fill-colorLogoBg transition-all duration-500"
                            ></circle>
                            <path
                              fill="#fff"
                      ...
                      >
                        ...
                        >
                          ...
                          <path
                            ...
                            fill="#c69"
                            className="group-hover:fill-[#c69] fill-colorLogoBg transition-all duration-500"
                          />
                          <path
                            ...
                            fill="#fff"
                            className="group-hover:fill-[#fff] fill-colorLogoInner transition-all duration-500"
                          />
                        </svg>
                      </div>
                      ...
                      >
                        ...
                        >
                          ...
                          <path
                            ...
                            fill="#44a8b3"
                            className="group-hover:fill-[#44a8b3] fill-colorLogoInner transition-all duration-500"
                          />
                        </svg>
                      </div>
                      ...
                      >
                        ...
                        >
                          <circle
                            ...
                            r="10"
                            fill="#fff"
                            className="group-hover:fill-[#fff] fill-colorLogoBg transition-all duration-500"
                          ></circle>
                          <path
                            fill="#3442AB"
                            ...
                            className="group-hover:fill-[#3442AB] fill-colorLogoInner transition-all duration-500"
                          ></path>
                        </svg>
                      </div>
                    </div>
                ...
                {/* <article className="relative mt-auto pt-16 mb-32 flex flex-col justify-end z-10 w-full h-full pb-12 ">
                  ...
                  <section className="relative p-16 after:h-screen after:max-h-[50dvh] before:max-h-[50dvh] after:border after:border-white after:rounded after:border-opacity-10 after:w-[calc(100%-2rem)] after:right-0 after:absolute after:z-[-3] after:-bottom-8 before:h-screen before:absolute before:bottom-0 before:w-[calc(100%-2rem)] before:left-0 before:bg-gradient-to-tr before:from-colorBgLight/[0.01] before:to-colorBgLight/[0.8] before:z-[-2] before:rounded-lg">
