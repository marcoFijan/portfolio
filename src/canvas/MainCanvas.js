  ...
  return (
    <div className="w-full h-screen">
      {mobile ? (
        <>
          <Container>
            <section className="relative pt-26 flex flex-col sm:flex-row items-start justify-start">
              <article className=" left-0 bottom-0 xl:h-min xl:bottom-[unset] xl:pt-32 w-full xl:w-1/2 flex flex-col justify-start relative">
                ...
                >
                  ...
                  toegankelijke en goed geteste interfaces die niet alleen goed
                  werken, maar ook intuïtief aanvoelen.
                </P>
                ...
                <Action>
                  <NextLink className={"block"} type="primary" href="/contact">
                    Neem contact op!
                  </NextLink>
                  <NextLink
                    className={"block"}
              ...
              <div className="m-0 p-0 box-border h-[40vh] sm:h-[50vh] w-full sm:max-w-[35%] relative sm:block hidden ">
                <Image
                  alt="Marco Hero Image"
                  width={1000}
                  height={2000}
                  src="/images/marcoHero.png"
                  className="-scale-x-100 grayscale-[95%] opacity-75 absolute top-20 left-1/2 -translate-x-1/2 h-full border-b-2 border-white sm:h-[30vh]  sm:max-w-full  object-top object-cover overflow-visible z-0 fade-bottom"
                />
              </div>
            </section>
            <Article className="my-14">
              <section className="grid grid-cols-1 xs:grid-cols-6 w-full h-full items-stretch box-border">
                ...
                <P
                  className={
                    "text-xl  text-white/40 col-span-1 xs:col-span-6 text-end my-10"
                  }
                >
                ...
                <P
                  className={
                    "text-xl  text-white/40 col-span-1 xs:col-span-6 my-10"
                  }
                >
                ...
                <P
                  className={
                    "text-xl  text-white/40 col-span-1 xs:col-span-6 text-center my-10"
                  }
                >
            ...
            <Article className="my-14">
              ...
              <Action className={"justify-center"}>
                <NextLink type="primary" href="/projects">
                  Bekijk alle projecten
                </NextLink>
              </Action>
            </Article>
          ...
          <section className="mx-4 pt-10 box-border w-[100%-1rem] rounded-t-2xl border-b-0 border-white/[0.5] border-1 bg-gradient-to-bl from-color-bg-top via-color-bg-bottom to-color-bg-top ">
            <Container>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 w-full gap-4">
                ...
                <div className="lg:mt-4 mt-[-50px] mb-20">
                  ...
                  <ul className="list-disc text-white opacity-70 ml-4">
                    ...
                    <Li>
                      Ontwikkeling opdrachtgevers dashboard (NextJS, Api calls
                      en Tailwind)
                    </Li>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 w-full gap-4">
                ...
                <div className="lg:mt-4 mt-[-50px] mb-20">
                  ...
                  <ul className="list-disc text-white opacity-70 ml-4">
                    ...
                    <Li>
                      Ontwikkeling met Wordpress, Advanced Custom Fields, CSS,
                      Jquery en PHP
                    </Li>
                  </ul>
                </div>
            ...
            <Suspense fallback={null}>
              ...
              <ScrollControls pages={pages} damping={mobile ? 0 : 0.1}>
                ...
                <Scroll html className="w-full">
                  <SectionHome
                    amountOfPages={mobile ? "4" : "3"}
                    className={"flex flex-col relative"}
                  >
                    <Container>
                      <section className="relative grid grid-cols-2 lg:grid-cols-2 gap-6 items-center justify-end">
                        <div className="m-0 p-0 box-border h-[30vh] sm:h-[50vh] threeDSlider w-full xl:self-end xl:min-h-screen relative lg:order-2">
                        ...
                        <article className="pt-24 h-[70vh] sm:h-[50vh] left-0 bottom-0 xl:h-min xl:bottom-[unset] xl:pt-32 w-full lg:order-1 flex flex-col justify-center relative">
                          <H1 chapeau={"Marco Fijan"} className={""} big>
                            een wens, <br />
                            een product. <br />
                          </H1>
                          <P>
                            Hi, ik ben Marco Fijan, een frontend developer met
                            een passie voor pixel-perfect webapplicaties,
                            betrouwbare code en gebruiksvriendelijke
                            ervaringen.{" "}
                          </P>
                          <P
                            className={
                          ...
                          >
                            Met een sterke focus op moderne webtechnologieën en
                            gebruikerservaring (UX) design bouw ik schaalbare,
                            toegankelijke en goed geteste interfaces die niet
                            alleen goed werken, maar ook intuïtief
                            aanvoelen.{" "}
                          </P>

                          <div class="inv-rad inv-rad-3 bg-blue-600 text-white px-6 py-4 text-2xl">
                    ...
                    <Article className="h-full">
                      <section className="grid lg:gap-24 grid-cols-1 lg:grid-cols-6 w-full h-full items-stretch box-border pt-24">
                        ...
                        >
                          In een toekomst waarin AI steeds meer op elkaar gaat
                          lijken, werk ik graag aan unieke concepten die echt
                          opvallen.
                        </P>
                        <P
                          className={
                    ...
                    <Container>
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-2 w-full gap-4">
                        ...
                        <div className="lg:mt-4 mt-[-50px] mb-20">
                          ...
                          <ul className="list-disc text-white opacity-70 ml-4">
                            <Li>
                              Ondersteuning en ontwikkeling voor diverse klanten
                              met Kentico of Umbraco CMS
                            </Li>
                            <Li>
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-2 w-full gap-4">
                        ...
                        <div className="lg:mt-4 mt-[-50px] mb-20">
                          ...
                          <ul className="list-disc text-white opacity-70 ml-4">
                            <Li>Ontwerp GWOTY award website (Figma)</Li>
                            <Li>
                              Ontwikkeling GWOTY award website (NextJS, Api
                              calls en Tailwind)
                            </Li>
                            <Li>Ontwerp opdrachtgevers dashboard (Figma)</Li>
                            <Li>
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-2 w-full gap-4">
                        ...
                        <div className="lg:mt-4 mt-[-50px] mb-20">
                          ...
                          <ul className="list-disc text-white opacity-70 ml-4">
                            <Li>
                              Ontwikkel Wordpress website met een goedgekeurd
                              Adobe Illustrator Design
                            </Li>
                            <Li>
                              Ontwikkeling met Wordpress, Advanced Custom
                              Fields, CSS, Jquery en PHP
                            </Li>
                          </ul>
                        </div>
                      </div>
