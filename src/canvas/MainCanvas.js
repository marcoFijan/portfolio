            ...
            <Container>
              ...
              >
                <div className="m-0 p-0 box-border h-[50vh] threeDSlider w-full xl:w-1/2 xl:self-end xl:min-h-screen relative group">
                  <div className="relative opacity-50 z-10 w-full h-screen text-center overflow-visible  scale-[20%] xs:scale-[30%] sm:scale-[40%] md:scale-[40%] lg:scale-[50%] xl:scale-[40%] 2xl:scale-[60%] max-h-[25vh] lg:max-h-[50vh]">
                    {/* <!-- 3D Slider --> */}
                    <div
                  ...
                  <Image
                    ...
                    className="-scale-x-100 grayscale-[95%] opacity-75 absolute top-[12vh] lg:top-[20vh] left-1/2 -translate-x-1/2 h-[70vh] lg:h-[80vh] max-w-[70%] xl:max-w-full object-top object-cover xl:object-contain overflow-visible xl:object-bottom z-0"
                  />
                </div>
