                    ...
                    <Container className="relative grid grid-cols-2 lg:grid-cols-2 gap-6 h-max items-center justify-end pt-20 lg:pt-40">
                      <article>
                        ...
                        <P>
                          ...
                          passie voor pixel-perfect webapplicaties, betrouwbare
                          code en gebruiksvriendelijke ervaringen.{" "}
                        </P>
                        <P>
                          Met een sterke focus op moderne webtechnologieën en
                          gebruikerservaring (UX) design bouw ik schaalbare,
                          toegankelijke en goed geteste interfaces die niet
                          alleen goed werken, maar ook intuïtief aanvoelen.{" "}
                        </P>
                      ...
                      <div className="m-0 p-0 box-border h-[30vh] sm:h-[50vh] threeDSlider w-full lg:order-2 absolute bottom-0 right-0 lg:w-1/2">
                        ...
                        <Image
                          ...
                          width={1000}
                          height={2000}
                          src="/images/marcoLooking.png"
                          className=" grayscale-[95%] opacity-75 object-contain absolute left-1/2 -translate-x-1/2 max-h-full h-full top-1/3 border-b-2 border-white max-w-full xl:max-w-full object-top xl:object-contain overflow-visible xl:object-bottom z-0 fade-bottom"
                        />
                      </div>
                    </Container>

                    <section className="relative my-30 bg-color-bg-bottom-light inverted-card py-20 lg:py-20">
                      <svg
                        width="160"
                        height="160"
                        viewBox="0 0 200 200"
                      ...
                      <Container>
                        <Article className="h-full">
                          <section className="grid lg:gap-24 grid-cols-1 lg:grid-cols-6 w-full h-full items-stretch box-border pt-24">
                            ...
                            >
                              In een toekomst waarin AI steeds meer op elkaar
                              gaat lijken, werk ik graag aan unieke concepten
                              die echt opvallen.
                            </P>
                            <P
                              className={
                      ...
                      <svg
                        ...
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                        className=" absolute w-30 h-30 left-0 -bottom-29.5 rotate-90"
                      >
                        <path
                          d="M0 0C0 110.457 89.5431 200 200 200H0V0Z"
                          className="fill-color-bg-bottom-light"
                      ...
                      <svg
                        ...
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                        className=" absolute w-30 h-30 right-0 -bottom-29.5 rotate-180"
                      >
                        <path
                          d="M0 0C0 110.457 89.5431 200 200 200H0V0Z"
                          className="fill-color-bg-bottom-light"
