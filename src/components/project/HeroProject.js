  ...
  return (
    <section className="relative">
      <Container grid>
        ...
        <div className="hidden lg:block relative w-full h-[10rem] col-span-12">
        ...
        <div className="w-full col-span-12 lg:col-span-10 lg:col-start-2 mx-auto relative z-10">
          <section className="mb-10 md:mb-20 relative">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 w-screen -z-100 h-full pointer-events-none">
              <svg
                className="w-full text-white fill-current -mb-1"
                viewBox="0 0 1440 88"
              ...
              <div className="bg-white w-full h-600" />
            </div>
          </section>
        </div>

        <article className="w-full col-span-12 lg:col-span-7 mx-auto relative z-10">
        ...
        <section className="w-full col-span-12 lg:col-span-4 lg:col-start-9 z-10">
