...
export default function AboutSection({ mobile }) {
  ...
  return (
    <section
      id="about"
      className="relative my-30 xl:my-60 bg-white inverted-card "
    >
      <div
        id="about-end"
      ...
      <svg
        className="w-full translate-y-[99%] text-white -scale-y-100"
        viewBox="0 0 1440 88"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
      >
