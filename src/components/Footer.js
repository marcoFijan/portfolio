...
export default function Footer() {
  return (
    <footer className="w-full bg-transparent dark py-16">
      <section className="w-full flex flex-col items-center text-center justify-center">
        <H3 className="text-black">Neem contact op</H3>
        ...
        <div className="flex gap-4">
          ...
          <Button
            ...
            className="fill-black hover:fill-color-accent hover:stroke-color-accent hover:text-color-accent"
          >
            <svg
              viewBox="0 0 90 90"
          ...
          <Button
            ...
            className="fill-black hover:fill-color-accent hover:stroke-color-accent hover:text-color-accent group"
          >
            <svg
              className="fill-inherit shrink-0 w-10 h-10 p-1"
              viewBox="0 0 20 20"
            >
              <g fill="none" fillRule="evenodd">
                <g transform="translate(-140.000000, -7559.000000)" className="fill-black group-hover:fill-color-accent ease-in-out duration-500">
        ...
        {/* Divider */}
        <div className="bg-gradient-to-r from-gray-200/0 via-gray-300 to-gray-200/0 w-full max-w-[40rem] h-[1px] my-8"></div>

        <P className="m-0 py-2 leading-0 text-gray-700">
